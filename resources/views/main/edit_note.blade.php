...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col">
            ...
            @include('main.components.top_bar')
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-primary text-white" name="text_title" value="{{ old('text_title', $note->text_title) }}">
                            {{-- show error --}}
                            @error('text_title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control bg-primary text-white" name="text_content" rows="5">{{ old('text_content', $note->text_content) }}</textarea>
                            {{-- show error --}}
                            @error('text_content')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
